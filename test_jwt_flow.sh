...
CHECKOUT_DATA="${CHECKOUT_DATA}&credit_card_number=4432-8015-6152-0454"
...
echo -e "==========================================${NC}"
echo ""
echo "Summary of User Journey:"
echo "  1. ✓ Landing Page - Skipped JWT for public services"
echo "  2. ✓ Add to Cart - Compressed JWT sent to Cart Service"
echo "  3. ✓ View Cart - Compressed JWT sent to Cart Service"
echo "  4. ✓ Place Order - Checkout orchestrated 4 services with compressed JWT"
echo "     - Payment Service"
echo "     - Shipping Service"
echo "     - Email Service"
echo "     - Cart Service (empty cart)"
echo "  5. ✓ Continue Shopping - Skipped JWT for public services"
echo ""
echo "🎯 JWT Compression Benefits:"
echo "  • Static headers cached by HPACK (alg, typ, iss, aud, name)"
echo "  • Session headers cached per connection (sub, session_id, cart_id)"
echo "  • Only dynamic headers change (exp, iat, jti)"
echo "  • Bandwidth savings: ~45% per request after initial handshake"
echo ""
